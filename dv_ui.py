...
while True: 
	...
	# if user types QUIT then the screen will close 
		...
		if event.type == pygame.MOUSEBUTTONDOWN: 
			...
			if finish_rect.collidepoint(event.pos):
				...
				exitvalue = True # DO SOMETHING WITH THIS!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	text1 = base_font.render("Starting Location: ", True, (0,0,0))
	text2 = base_font.render("Destination Location: ", True, (0,0,0))
	text3 = base_font.render("GO", True, (0,0,0))
